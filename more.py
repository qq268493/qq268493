...
bot_token = '7938145127:AAEqMqpDCpDidGk1R9gwxtigw8WpyO0_rC4'
bot = telebot.TeleBot(bot_token)
user_data = {}
allowed_users = ['1961752558']
admin_id = '1743576400'
subscription_data = {}
...
def start(message):
    ...
    if user_id in allowed_users:
        ...
        bot.reply_to(message, 'أهلاً بك في بوت رفع خارجي لـ مطور:  @Slight5', reply_markup=keyboard)
    else:
        bot.reply_to(message, 'انت غير مشترك في البوت للاشتراك في البوت :  @Slight5 ')
...
def show_admin_commands(message):
    if str(message.from_user.id) == '1961752558':  
